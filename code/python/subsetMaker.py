...
def main():
	...
	parameterList.append(('NeuronDataMaster.csv', './subsets/speciesCountOver100_NeuronDataMaster.csv', 'if data_set.ix[rowNum, \'Species Name\'] in [\'elephant\', \'pouched lamprey\', \'salamander\', \'minke whale\', \'goldfish\', \'blowfly\', \'bottlenose dolphin\', \'chicken\', \'frog\', \'Siberian tiger\', \'clouded leopard\', \'guinea pig\', \'zebrafish\', \'proechimys\', \'drosophila melanogaster\', \'manatee\', \'moth\', \'spiny lobster\', \'rabbit\']:'))

	# 18. Set with only those species that appear less than 100 times in the original dataset. 
	parameterList.append(('NeuronDataMaster.csv', './subsets/speciesCountUnder100_NeuronDataMaster.csv', 'if data_set.ix[rowNum, \'Species Name\'] in [\'rat\', \'mouse\', \'human\', \'chimpanzee\', \'monkey\', \'giraffe\', \'C. elegans\', \'sheep\', \'domestic pig\', \'humpback whale\', \'cat\']:'))
